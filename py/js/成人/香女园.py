...
class Spider(SpiderBase):
    def __init__(self):
        ...
        self.siteUrl = "https://ikt.xny6.makeup"
    ...
    def homeContent(self, filter=False):
        return {
            "class": [
                ...
                {"type_name": "偷拍自拍", "type_id": "22"},
                {"type_name": "风骚寡妇", "type_id": "23"},
                {"type_name": "制服师生", "type_id": "24"},
                {"type_name": "欧美性爱", "type_id": "25"},
                {"type_name": "JAV高清", "type_id": "26"},
                {"type_name": "VR虚拟", "type_id": "27"},
                {"type_name": "无码视频", "type_id": "28"},
                {"type_name": "有码视频", "type_id": "29"},
                {"type_name": "国产视频", "type_id": "30"},
                {"type_name": "女同", "type_id": "31"},
                {"type_name": "动漫", "type_id": "32"},
                {"type_name": "三级伦理", "type_id": "33"}
            ]
        }
    ...
    def categoryContent(self, tid, pg="1", filter=False, extend=None):
        ...
        for full_a, play_href, inner in card_matches:
            ...
            for attr in ("src", "data-original", "data-src"):
                img_m = re.search(r'<img[^>]+%s=["\']([^"\']+)["\']' % attr, inner, re.I)
                if not img_m:
                    img_m = re.search(r'<img[^>]+%s=["\']([^"\']+)["\']' % attr, full_a, re.I)
                if img_m:
