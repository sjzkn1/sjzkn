...
class Spider(SpiderBase):
    def __init__(self):
        ...
        self.siteUrl = "https://asfdyq.wcsp7.beer"
    ...
    def homeContent(self, *args, **kwargs):
        return {
            "class": [
                {"type_name": "亚洲情色", "type_id": "/vodtype/20.html"},
                {"type_name": "强奸乱伦", "type_id": "/vodtype/21.html"},
                {"type_name": "偷拍自拍", "type_id": "/vodtype/22.html"},
                {"type_name": "风骚寡妇", "type_id": "/vodtype/23.html"},
                {"type_name": "制服师生", "type_id": "/vodtype/24.html"},
                {"type_name": "欧美性爱", "type_id": "/vodtype/25.html"},
                {"type_name": "JAV高清", "type_id": "/vodtype/26.html"},
                {"type_name": "VR虚拟", "type_id": "/vodtype/27.html"},
                {"type_name": "无码视频", "type_id": "/vodtype/28.html"},
                {"type_name": "有码视频", "type_id": "/vodtype/29.html"}
            ]
        }
